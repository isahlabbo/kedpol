<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-purple-800 leading-tight">
            {{ $stateConstituency->name }} Constituency
        </h2>
    </x-slot>
    ...
    <div class="p-6 sm:px-20 bg-white border-b border-gray-200">
        ...
        <thead>
           <tr>
               ...
               <th class="w-1/3">Ward Name</th>
               <th class="w-1/8">Polling Units</th>
               <th class=""></th>
           </tr>
        </thead>
        <tbody>
            ...
            <tr class="">
                ...
                <td>
                    <a href="{{route('state-constituency.ward.polling-unit.index',[$stateConstituencyWard->ward->id])}}">
